...
class TestChatAccessRequest:
    ...
    def test_status_colored(self, mocker):
        ...
        obj = ChatAccessRequest(nome="João", email="j@x.com", motivo="X", status="aprovado")
        obj.save()
    ...
    def test_informar_decisao_aprovado(self, mocker):
        mock = mocker.patch("access.utils.email_utils.enviar_email_async.delay")
        obj = ChatAccessRequest(nome="João", email="joao@example.com", motivo="Teste", status="aprovado")
    ...
    def test_informar_decisao_recusado_com_motivo(self, mocker):
        mock = mocker.patch("access.utils.email_utils.enviar_email_async.delay")
        obj = ChatAccessRequest(nome="João", email="joao@example.com", motivo="Teste", status="recusado")
    ...
    def test_get_queryset_com_e_sem_filtro(self, mocker):
        mock = mocker.patch("access.utils.email_utils.enviar_email_async.delay")
        ChatAccessRequest.objects.create(nome="Aprovado", email="a@a.com", motivo="x", status="aprovado")
        ChatAccessRequest.objects.create(nome="Recusado", email="b@b.com", motivo="y", status="recusado")
    ...
    def test_chat_access_request_list_view_get(self, mocker):
        ...
        # Cria dados de teste
        ChatAccessRequest.objects.create(nome="Ana", email="ana@example.com", motivo="teste", status="aprovado")
        ChatAccessRequest.objects.create(nome="Bruno", email="bruno@example.com", motivo="outro", status="pendente")
